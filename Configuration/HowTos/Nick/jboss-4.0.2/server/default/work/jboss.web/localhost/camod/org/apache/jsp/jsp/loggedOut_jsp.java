...
/**
 * 
 * $Id: loggedOut_jsp.java,v 1.1 2008-07-22 19:39:44 pandyas Exp $
 * 
 ...
 */
	...
	if( session.getAttribute("camod.loggedon.username") != null ) {
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td class=\"formTitle\" height=\"20\">You have been logged off</td>\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td class=\"resultsBoxWhiteEnd\">Thank you for using caMOD.<br>");
  ...
  private boolean _jspx_meth_html_link_7(PageContext _jspx_page_context)
    ...
    _jspx_th_html_link_7.setAction("login");
