...
public final class infoReleaseNotes_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/**
 * 
 * $Id: infoReleaseNotes_jsp.java,v 1.1 2008-07-22 19:39:44 pandyas Exp $
 * 
 ...
 */
	...
	if( session.getAttribute("camod.loggedon.username") != null ) {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"formTitle\" height=\"20\">Release Notes</td>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("                           Feb 2008\r\n");
      out.write("\r\n");
      out.write("       National Cancer Institute's Center for Bioinformatics\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      ...
      out.write("================================================================\r\n");
      out.write("    \r\n");
      out.write("    1.0 caMOD Introduction and History\r\n");
      out.write("    2.0 Release History\r\n");
      out.write("    3.0 New Features and Updates\r\n");
      out.write("    4.0 Bugs Fixed Since Last Release\r\n");
      out.write("    5.0 Known Issues/Defects\r\n");
      out.write("    6.0 Bug Reports and Support\r\n");
      out.write("    7.0 NCICB Web Pages\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      out.write("    1.0 caMOD Version 2.4 Introduction and History\r\n");
      out.write("================================================================\r\n");
      out.write(" \r\n");
      out.write("\r\n");
      out.write("    caMOD 2.4, the Cancer Models Database, is a open source data management \r\n");
      out.write("    system developed for the management and sharing of data of animal models. \r\n");
      out.write("    caMOD features controlled vocabularies from a shared, publicly accessible metadata repository (caDSR) and enterprise vocabulary services (EVS) from the National \r\n");
      out.write("    Cancer Institute.  \r\n");
      out.write("\r\n");
      out.write("    -- http://cancermodels.nci.nih.gov\r\n");
      out.write("\r\n");
      out.write("    caMOD is a product of the NCI Center for Bioinformatics and its partners. Visit \r\n");
      out.write("    the NCICB web site and the emice website for more information: \r\n");
      out.write("\t\r\n");
      out.write("   -- http://ncicb.nci.nih.gov/\r\n");
      out.write("   -- http://emice.nci.nih.gov/ \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      out.write("    2.0 Release History\r\n");
      out.write("================================================================\r\n");
      out.write("    caMOD Version 2.4 \r\n");
      out.write("    --\tFeb 2008 \r\n");
      out.write("\r\n");
      out.write("    caMOD Version 2.3 \r\n");
      out.write("    --\tSept 2007 \r\n");
      out.write("        \r\n");
      out.write("    caMOD Version 2.2\r\n");
      out.write("    --\tNovember 30th 2006 \r\n");
      out.write("    \r\n");
      out.write("    caMOD Version 2.1.1\r\n");
      out.write("    --\tOctober 16th 2006 \r\n");
      out.write("    \r\n");
      out.write("    caMOD Version 2.1\r\n");
      out.write("    --\tMay 30th 2006    \r\n");
      out.write("    \r\n");
      out.write("    caMOD Version 2.0\r\n");
      out.write("    --\tDecember 21 2005    \r\n");
      out.write("\r\n");
      out.write("    caMOD Version 1.0\r\n");
      out.write("    --\tFall 2001; continously updated until April 2005\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      out.write("    3.0 New Features and Updates\r\n");
      out.write("================================================================\r\n");
      out.write("\r\n");
      out.write("caELMIR Integration\r\n");
      out.write("\r\n");
      out.write("caELMIR, the Cancer Electronic Laboratory Management Information Resource (http://caelmir.compmed.ucdavis.edu/caelmir/) is a laboratory information management tool that helps bench scientists to store, manage, and share experimental data generated during preclinical trials. The connection between caMOD and caELMIR  enables caMOD users to retrieve data generated in preclinical trials and review information about studies, experiments, protocols, and animals. The caELMIR study information is shown on the Therapeutic Approaches search page in caMOD. For additional data, the user will be directed to caELMIR. (GForge entry #8816)\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("Object Model changes as a result of the VCDE silver level compliance review:\r\n");
      out.write("\r\n");
      out.write("Following the recommendations made by the Vocabulary and Common Data Elements Workgroup (https://cabig.nci.nih.gov/workspaces/VCDE) during the caMOD review the following changes were made:\r\n");
      out.write("- Introduction of a gene object to comply with the gene identifier standard (GForge entry #9756, #8187, #11878)\r\n");
      out.write("- Rename UnctrlVocab items to Alterntext entries (GForge entry #9756)\r\n");
      out.write("- Rename Graft object into Transplant object (GForge entry #8290)\r\n");
      out.write("- Add Comments field to every submission page (GForge entry #8355)\r\n");
      out.write("- Connect availability of model to person to resolve the available from investigator issue (GForge entry #9169)\r\n");
      out.write("\r\n");
      out.write("Other Changes\r\n");
      out.write("- Redesigned the publication search page (GForge entry #5169, #10679)\r\n");
      out.write("- Redesigned publication table on cell line and therapy search page  (GForge entry #10683)\r\n");
      out.write("- Improved navigation within the therapy search page. These changes were caused by the integration of the caELMIR data and the redesign of the publication table (GForge entry #10504)\r\n");
      out.write("- Updated online help including a downloadable user guide (PDF file)\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("NCICB Technology Stack Requirements (GForge entry #6779, #7079, #11880)\r\n");
      out.write("- Upgrade to Jboss 4.0.5 from 4.0.2 \r\n");
      out.write("- Upgrade to newer version of ANT for project\r\n");
      out.write("- Upgrade to use caCORE32 in caMOD and EVSTree to render vocabulary trees\r\n");
      out.write("\r\n");
      out.write("The caMOD 2.1 Common Data Elements (CDEs) are available via caDSR \r\n");
      out.write("(cancer Data Standard Repository) http://ncicb.nci.nih.gov/core/caDSR\r\n");
      out.write("  \r\n");
      out.write("  \r\n");
      out.write("================================================================\r\n");
      out.write("    4.0 Defects Fixed Since Last Release\r\n");
      out.write("================================================================\r\n");
      out.write("\r\n");
      out.write("- ATCC link not working on transplant search page (GForge entry #11878) \r\n");
      out.write("- The left menu list needs to be changed for the viewInvivoDetails.jsp (GForge entry #11837, #9206) \r\n");
      out.write("- Comments for associated expression are not shown for targeted modification and genomic segment (GForge entry #11833) \r\n");
      out.write("- Maximize buttion in pop-up windows disabled which prevents user to see full page (GForge entry #11831)\r\n");
      out.write("- Fixed LDAP search function (GForge entry #7992, #8963, #11499)\r\n");
      out.write("- Data in construct description and construct title are not kept (GForge entry #11619)\r\n");
      out.write("- Fixed search function for rat anatomy, rat diseases, zebrafish anatomy, zebrafish developmental stages, and staining method vocabularies displayed in EVS tree (GForge entry #6389, 7387, 7451, 7790, 9274, 9277, 9425, 10818, 11022)\r\n");
      out.write(" \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      ...
      out.write("================================================================\r\n");
      out.write("    \r\n");
      out.write("    1. Organ-specific preselection of diagnoses in the vocabulary trees is \r\n");
      out.write("       not available\r\n");
      out.write("    \r\n");
      out.write("    2. Users need to have a caArray user account in order to submit data to \r\n");
      out.write("        caArray, users need to inform caMOD team if they would like to have \r\n");
      out.write("        experiments in caArray linked to their caMOD entries\r\n");
      out.write("        \r\n");
      out.write("    3. Genetic Description view screen does not include data for the following \r\n");
      out.write("        sections: Libraries and Tissues (from EST data) or Protein Similarities \r\n");
      out.write("        (from UniGene). caBio discontinued support for the Protein Similarities and \r\n");
      out.write("        the performance for the Libraries and Tissues query did not meet minimum standards.  \r\n");
      out.write("        After meeting with the caBio team, it was concluded that the development team will need to eliminate lazy fetching for library and tissue attributes \r\n");
      out.write("        if we want to improve performance.\r\n");
      out.write("     \r\n");
      out.write("    Please report any defects found to application support.\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      out.write("    6.0 Bug Reports and Support\r\n");
      out.write("================================================================\r\n");
      out.write("    \r\n");
      out.write("    Send email to ncicb@pop.nci.nih.gov to request support.\r\n");
      out.write("\r\n");
      out.write("    In addition, mailing lists are used by the caMOD developer\r\n");
      out.write("    and user community to exchange ideas and make announcements.\r\n");
      out.write("\r\n");
      out.write("    You can subscribe at this address: http://list.nih.gov\r\n");
      out.write("\r\n");
      out.write("    caMOD users\r\n");
      out.write("        CAMOD_USERS-L\r\n");
      out.write("        \r\n");
      out.write("    caMOD developers\r\n");
      out.write("       CAMOD_DEVELOPERS-L \r\n");
      out.write("\r\n");
      out.write("================================================================\r\n");
      out.write("    7.0 NCICB Web Pages\r\n");
      out.write("================================================================\r\n");
      out.write("    \r\n");
      out.write("    The NCI Center for Bioinformatics\r\n");
      out.write("    --  http://ncicb.nci.nih.gov/\r\n");
      out.write("    \r\n");
      out.write("    NCICB Application Support\r\n");
      out.write("    --  http://ncicb.nci.nih.gov/NCICB/support\r\n");
      out.write("\r\n");
      out.write("    caMOD\r\n");
      out.write("    --  http://cancermodels.nci.nih.gov/\r\n");
      out.write("    \r\n");
