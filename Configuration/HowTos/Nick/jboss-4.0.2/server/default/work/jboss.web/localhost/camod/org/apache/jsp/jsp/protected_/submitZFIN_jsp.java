...
public final class submitZFIN_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/**
 * 
 * $Id: submitZFIN_jsp.java,v 1.1 2008-07-22 19:39:12 pandyas Exp $
 * 
 ...
 */
    ...
    if ( aAvailabilityID != null && aAvailabilityID.length() > 0 && isDeleted == null) {
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\r\n");
          out.write("\t<tr>\r\n");
          out.write("\t\t<td class=\"formTitle\" height=\"20\" colspan=\"3\">Available from ZFIN (Zebrafish Information Network) \r\n");
          out.write("\t\t\t");
          ...
          out.write("            <td class=\"formLabel\">ZFIN Identifier:\r\n");
          out.write("            </td>\r\n");
          out.write("\t\t\t<td class=\"formField\">\r\n");
          out.write("\t\t\t\t<input type=button value=\"Find Info\" onClick=\"myRef = window.open('http://zebrafish.org/zirc/home/guide.php','mywin',\r\n");
          out.write("\t\t\t\t'left=20,top=20,width=800,height=700,status=1,scrollbars=1,toolbar=1,resizable=0');myRef.focus()\"></input>\r\n");
          out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_camod_cshelp_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_camod_cshelp_0.setTopic("ZFIN_help");
