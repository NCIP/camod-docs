...
public final class submitMicroarrayData_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/**
 * 
 * $Id: submitMicroarrayData_jsp.java,v 1.1 2008-07-22 19:39:14 pandyas Exp $
 * 
 ...
 */
	...
	if( session.getAttribute("camod.loggedon.username") != null ) {
      ...
      out.write("\r\n");
      out.write("<FORM name=\"input\" action=\"http://caarraydb.nci.nih.gov\" method=\"get\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- submitMicroarrayData.jsp -->\r\n");
      out.write("<!-- Main Content Begins -->\r\n");
      ...
      out.write("<!-- -->\r\n");
      out.write("\r\n");
      out.write("\t<TABLE summary=\"\" cellpadding=\"6\" cellspacing=\"0\" border=\"0\" align=\"left\">\r\n");
      out.write("\t\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class=\"formTitle\" height=\"20\" colspan=\"3\">Microarray Data &nbsp;\r\n");
      out.write("\t\t");
      ...
      out.write("\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class=\"greyBox\" height=\"20\" colspan=\"3\">\r\n");
      out.write("    <b>Microarray data is stored in the caArray portal. Follow these simple steps to upload microarray data to caArray.\r\n");
      out.write("    <ol >\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">Click <a href=\"http://caarraydb.nci.nih.gov/\" target=\"_caArray\">here</a> to login into caArray. A new browser window opens. (Be sure and turn off any pop-up blockers for this site.) <br/>\r\n");
      out.write("    \t\tIf you do not have a caArray login userID (or if you have forgotten your ID), follow the instructions of the caArray page to obtain an account.\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\tSubmit microarray data by following the on-screen instructions. (For more information, refer to the <i>caArray User's Guide</i>, downloadable from <a href=\"http://ncicb.nci.nih.gov/download/downloadcaarray.jsp\" target=\"_caArray\">here</a>\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\tSet the visibility of the micro-array experiment to <b>Public</b>.\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\tWhen you have finished uploading the microarray data to caArray, record the following: <br/>\r\n");
      out.write("    \t\t&nbsp;&nbsp;&nbsp;&nbsp;a. The Experiment name<br/>&nbsp;&nbsp;&nbsp;&nbsp;b. The system-generated Experiment ID (looks like 10007638).\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\tLog out of the caArray application and close caArray.\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\t<a href=\"mailto:mmhcc-dev@list.nih.gov\">Email</a> the caMOD development team requesting that the microarray data be associated with your cancer model. Include the microarray experiment name(s) and the experiment ID(s) in your email.\r\n");
      out.write("    \t</li>\r\n");
      out.write("    \t<li style=\"padding-bottom:7px\">\r\n");
      out.write("    \t\tThe microarray data will be linked to your cancer model within 24 hours (excluding Government holidays and weekends). You will be notified by email when this task is completed.\r\n");
      out.write("    \t</li>\r\n");
      out.write("    </ol>\r\n");
      out.write("    </b>\r\n");
      out.write("        The application accepts the submission of Affymetrix and Spotted Array experiments.<br><br>\r\n");
      out.write("    <ul style=\"list-style-type: square\">\r\n");
      out.write("    <li style=\"padding-bottom:8px\">If you are submitting an Affymetrix experiment, you can upload the various Affymetrix files (*.dat, *.cel, *.chp, *.txt.). All the data is stored in the MIAME-compliant caArray database, available for retrieval at a later time.</li>\r\n");
      out.write("    <li style=\"padding-bottom:8px\">Spotted Array experiments must be accompanied by a Gene Array List (*.gal) file and a GenPix results (*.gpr) file. Additional file formats will be added in response to community feedback.</li>\r\n");
      out.write("    </ul>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_camod_cshelp_0(PageContext _jspx_page_context)
    ...
    _jspx_th_camod_cshelp_0.setTopic("microarray_data_help");
