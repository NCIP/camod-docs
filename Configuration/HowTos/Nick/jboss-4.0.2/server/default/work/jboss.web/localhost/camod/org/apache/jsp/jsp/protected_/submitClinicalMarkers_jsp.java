...
public final class submitClinicalMarkers_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/**
 * 
 * $Id: submitClinicalMarkers_jsp.java,v 1.1 2008-07-22 19:39:13 pandyas Exp $
 * 
 ...
 */
	...
	if ( aClinicalMarkerID != null && aClinicalMarkerID.length() > 0 && isDeleted == null) {
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\r\n");
          out.write("<!-- submitClinicalMarkers.jsp -->\r\n");
          out.write("<!-- Main Content Begins -->\r\n");
          ...
          out.write("\r\n");
          out.write("\t<tr>\r\n");
          out.write("\t\t<td class=\"formTitle\" height=\"20\" colspan=\"3\">Clinical Marker&nbsp;\r\n");
          out.write("\t\t\t");
          ...
          out.write("                <TD class=\"formRequiredLabel\">Select Clinical Marker:</TD>\r\n");
          out.write("\t\t\t<td class=\"formField\">\r\n");
          out.write("\t\t\t<br>\r\n");
          out.write("\t\t\t<label for=\"field3\">(if Clinical Marker is not listed, then please<br>select \"Other\" from the list and specify it below)</label>\r\n");
          out.write("\t\t\t<br>\r\n");
          out.write("\t\t\t<br>\t\t\t\t\t\t\r\n");
          out.write("\t\t\t");
          //  html:select
          ...
          if (_jspx_eval_html_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_html_options_0.setName( Dropdowns.CLINICALMARKERSDROP );
          ...
          out.write("\t<tr>\r\n");
          out.write("\t\t<td class=\"formRequiredNotice\" width=\"5\">&nbsp;</td>\r\n");
          out.write("\t\t<td class=\"formLabel\"><label for=\"field1\">Other Clinical Marker:</label></td>\r\n");
          out.write("\t\t<td class=\"formField\">\r\n");
          out.write("\t\t\t");
          ...
          out.write("        <TR align=\"LEFT\" valign=\"TOP\">\r\n");
          out.write("            <td class=\"formRequiredNotice\" width=\"5\">&nbsp;</td>                    \r\n");
          out.write("            <TD class=\"formLabel\">Value:</TD>\r\n");
          out.write("\t\t\t<td class=\"formField\">\r\n");
          out.write("\t\t\t");
          ...
          _jspx_th_c_if_0.setTest("${not empty aClinicalMarkerID}");
          ...
          out.write("\">\r\n");
          out.write("\t\t\t\t  <input type=\"hidden\" name=\"aClinicalMarkerID\" value=\"");
          out.print( aClinicalMarkerID );
          out.write("\">\r\n");
          out.write("\t\t\t\t  \r\n");
          out.write("\t\t\t\t  \t\t\t\r\n");
          out.write("\t\t\t\t</TABLE>\r\n");
  ...
  private boolean _jspx_meth_camod_cshelp_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_camod_cshelp_0.setTopic("clinical_marker_help");
