...
public final class searchTableOfContents_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/**
 * 
 * $Id: searchTableOfContents_jsp.java,v 1.1 2008-07-22 19:39:43 pandyas Exp $
 * 
 ...
 */
	...
	if( session.getAttribute("camod.loggedon.username") != null ) {
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td class=\"formTitle\" height=\"20\" colspan=\"3\">Table of Contents\r\n");
      out.write("\t\t\t\t");
      ...
      _jspx_th_c_if_0.setTest("${not empty groupList}");
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_c_forEach_0.setItems("${groupList}");
          ...
          try {
            ...
            if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              do {
                ...
                _jspx_th_c_forEach_1.setVar("query");
                _jspx_th_c_forEach_1.setItems("${group.queries}");
                ...
                try {
                  ...
                  if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    do {
                      ...
                      _jspx_th_html_link_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_forEach_1);
                      _jspx_th_html_link_7.setAction("ViewTOCSearchResultsAction.do");
                      _jspx_th_html_link_7.setParamId(Constants.Parameters.TOCQUERYKEY);
                      _jspx_th_html_link_7.setParamName("query");
                      _jspx_th_html_link_7.setParamProperty("key");
                      ...
                      if (_jspx_eval_html_link_7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        ...
                        do {
                          out.write("\r\n");
                          out.write("\t\t\t\t                    ");
                          if (_jspx_meth_c_out_2(_jspx_th_html_link_7, _jspx_page_context, _jspx_push_body_count_c_forEach_1))
                            return;
                          out.write(' ');
                          out.write('(');
                          out.write(' ');
                          if (_jspx_meth_c_out_3(_jspx_th_html_link_7, _jspx_page_context, _jspx_push_body_count_c_forEach_1))
                            return;
                          out.write(" )\r\n");
                          out.write("\t                            ");
  ...
  private boolean _jspx_meth_camod_cshelp_0(PageContext _jspx_page_context)
    ...
    _jspx_th_camod_cshelp_0.setTopic("toc_help");
  ...
  private boolean _jspx_meth_c_set_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_0.setVar("groupList");
    _jspx_th_c_set_0.setValue("${TOC_QUERY_RESULTS}");
  ...
  private boolean _jspx_meth_c_out_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_1.setValue("${group.description}");
  ...
  private boolean _jspx_meth_c_out_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_link_7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_out_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_link_7);
    _jspx_th_c_out_2.setEscapeXml("false");
    _jspx_th_c_out_2.setValue("${query.description}");
  ...
  private boolean _jspx_meth_c_out_3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_link_7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_out_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_link_7);
    _jspx_th_c_out_3.setValue("${query.size}");
