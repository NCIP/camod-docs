...
Update IMAGE i set i.URL=replace (i.URL,'http://imageserver-dev.nci.nih.gov','http://imageserver.nci.nih.gov')  
...
Update IMAGE i set i.THUMB_URL=replace (i.THUMB_URL,'http://imageserver-dev.nci.nih.gov','http://imageserver.nci.nih.gov')  
